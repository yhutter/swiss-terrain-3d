...
/*
    ...
    Overview:
    =========
    Shader program: 'swissterrain3d':
        Get shader desc: swissterrain3d_shader_desc(sg_query_backend());
        Vertex Shader: vs
        Fragment Shader: fs
        Attributes:
            ATTR_swissterrain3d_pos => 0
            ATTR_swissterrain3d_color0 => 1
    Bindings:
*/
...
#endif
#endif
#define ATTR_swissterrain3d_pos (0)
#define ATTR_swissterrain3d_color0 (1)
/*
    #version 430
...
static inline const sg_shader_desc* swissterrain3d_shader_desc(sg_backend backend) {
    if (backend == SG_BACKEND_GLCORE) {
        ...
        if (!valid) {
            ...
            desc.label = "swissterrain3d_shader";
        }
        return &desc;
    }
